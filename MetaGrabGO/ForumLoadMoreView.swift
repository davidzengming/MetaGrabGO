...
struct ForumLoadMoreView: View {
    ...
    private func fetchNextPage() {
        self.forumDataStore.fetchThreads(access: self.userDataStore.token!.access, start: self.forumDataStore.forumNextPageStartIndex!, userId: self.userDataStore.token!.userId)
    }
